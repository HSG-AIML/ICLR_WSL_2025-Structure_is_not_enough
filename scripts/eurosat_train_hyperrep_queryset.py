...
PATH_ZOO = Path("/netscratch2/lmeynent/research/structure_vs_behaviour/results/zoos/eurosat_train_zoo_relu")
...
def main():
    ...
    config["training::queryset_distillation"] = tune.grid_search(["data", "random"])
    config["training::queryset_dump"] = tune.grid_search([
        "/netscratch2/lmeynent/research/structure_vs_behaviour/results/data/eurosat_train_zoo_relu/dataset.pt",
        "/netscratch2/lmeynent/research/structure_vs_behaviour/results/data/stl10_32/dataset.pt",
    ])
