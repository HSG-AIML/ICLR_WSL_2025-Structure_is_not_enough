...
PATH_ZOO = Path("/netscratch2/lmeynent/research/structure_vs_behaviour/results/zoos/svhn_train_zoo_relu")
...
def main():
    ...
    config["training::queryset_dump"] = tune.grid_search([
        "/netscratch2/lmeynent/research/structure_vs_behaviour/results/data/svhn_train_zoo_relu/dataset.pt",
