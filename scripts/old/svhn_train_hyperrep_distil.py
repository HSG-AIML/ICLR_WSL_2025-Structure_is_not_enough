...
PATH_ZOO = Path("/netscratch2/lmeynent/backdoored_zoos/zoos/SVHN/clean/tune_SVHN_clean_adv_train_zoo")
...
def main():
    ...
    config["optim::lr"] = tune.grid_search([1e-6, 1e-5, 1e-4])
    ...
    ### Distillation loss
    config["training::distil_reference"] = PATH_ZOO / "NN_tune_trainable_29d1c_00000_0_model_dropout=0.0000,model_init_type=uniform,model_nlin=tanh,optim_lr=0.0010,optim_optimizer=adam,_2024-01-20_11-36-35"
