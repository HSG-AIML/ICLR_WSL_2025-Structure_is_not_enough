...
def main():
    ...
    config["training::gamma"] = tune.grid_search([0., 0.05, 0.1])
    config["training::recon_on_canon"] = tune.grid_search([False, True])
    config["training::reduction"] = "mean"
    ...
    config["training::recon"] = tune.grid_search(["distillation", "both"])
