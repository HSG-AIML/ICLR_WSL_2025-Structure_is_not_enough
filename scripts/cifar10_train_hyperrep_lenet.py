...
PATH_ZOO = Path("/netscratch2/lmeynent/research/structure_vs_behaviour/results/zoos/cifar10_train_zoo_lenet")
...
def main():
    ...
    config["training::queryset_dump"] = "/netscratch2/lmeynent/research/structure_vs_behaviour/results/data/cifar10_train_zoo_lenet/dataset.pt"
