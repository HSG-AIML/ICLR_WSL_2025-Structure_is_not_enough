...
def main():
    ...
    try:
        ...
        eurosat_raw = EuroSAT(
            root='/netscratch2/lmeynent/datasets/EuroSAT',
        ...
        splits = [0.80, 0.05, 0.15]

        trainset_raw, valset_raw, testset_raw = torch.utils.data.random_split(
            eurosat_raw, splits, generator=torch.Generator().manual_seed(dataset_seed)
        )
